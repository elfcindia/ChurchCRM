...
describe("Family Reg", () => {
    before(() => {
        // Ensure church name is "Eternal Life Fellowship Church" regardless of what other tests may have set.
        ...
        cy.get("#sChurchName").clear().type("Eternal Life Fellowship Church");
        cy.wait(500);
    ...
    it("Adam Family Registration", () => {
        ...
        cy.contains("Eternal Life Fellowship Church");
