...
describe("Communication Menu and Dashboards", () => {
    ...
    it("Communication menu has Text sub-item", () => {
        cy.visit("v2/dashboard");
    ...
    describe("Email dashboard (direct URL)", () => {
        it("loads email dashboard for SMTP tools", () => {
            cy.visit("v2/email/dashboard");
            cy.contains("Email Dashboard");
        });

        it("admin can open email settings panel", () => {
            cy.visit("v2/email/dashboard");
