...
// UI toggles for this form
// - Social media fields are not used in this deployment.
// - Custom Fields should not appear during "Add New Person" (create) flow.
$showSocialMediaFields = false;
$showCustomFieldsCard = !$isNewPerson;
...
if (isset($_POST['PersonSubmit']) || isset($_POST['PersonSubmitAndAdd'])) {
    ...
    // Social media fields are optional and may be hidden from the UI.
...
<form method="post" action="PersonEditor.php?PersonID=<?= $iPersonID ?>" name="PersonEditor" id="personEditor">
    ...
    <?php if ($showCustomFieldsCard && $numCustomFields > 0) { ?>
        <div class="card clearfix">
            <div class="card-header d-flex align-items-center">
