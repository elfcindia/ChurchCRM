...
class DemoDataService
{
    ...
    public function importDemoData(bool $includeEvents = false, bool $includeSundaySchool = false): array
    {
        ...
        try {
            ...
            $this->importSystemConfig($includeSundaySchool);
     ...
     */
    private function importSystemConfig(bool $includeSundaySchool): void
    {
        ...
        foreach ($json as $key => $value) {
            // Skip bEnabledSundaySchool here; we'll set it explicitly from the API flag
            if ($key === 'bEnabledSundaySchool') {
                continue;
            }
        ...
        // Ensure the Sunday School feature toggle is set according to the API flag
        try {
