...
class   SystemConfig
{
    ...
    private static function buildConfigs(): array
    {
        return [
            ...
            'iWorshipAttendanceMemberGroupId'      => new ConfigItem('iWorshipAttendanceMemberGroupId', 'number', '0', gettext('Worship attendance: Group ID whose members are the “expected” list for absence reports. Set to 0 to use all active people (same rule as the dashboard: not inactive classification, active family).')),
    ...
    {
        return [
            gettext('New Members & Greeting') => ['sNewPersonNotificationRecipientIDs', 'IncludeDataInNewPersonNotifications', 'sGreeterCustomMsg1', 'sGreeterCustomMsg2', 'iWorshipAttendanceMemberGroupId'],    
            ...
            gettext('Fundraiser & Fiscal Settings') => ['bEnabledFundraiser', 'sDepositSlipType', 'iChecksPerDepositForm', 'bDisplayBillCounts', 'bUseScannedChecks', 'bEnableNonDeductible', 'iFYMonth', 'bUseDonationEnvelopes'],
