...
function initializeApp() {
  ...
  // Hide global loading overlay once app is ready
  const loadingEl = document.getElementById("crmGlobalLoading");
  if (loadingEl) {
    loadingEl.remove();
  }
}
...
// If the locale loader is slow or fails, keep the UI responsive by removing
// the global loading overlay after a short grace period.
setTimeout(() => {
